                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="widget">
                            ...
                            <address>
                                <strong>Exotic company Inc</strong><br>
                    ...
                    <div class="col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="link-list">
                                ...
                                <li>
                                    <a href="#">Pellentesque et pulvinar enim.
                                    Quisque at tempor ligula</a>
                                </li>

                                <li>
                                    <a href="#">Natus error sit voluptatem
            ...
            <div id="sub-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="copyright">
                                <p><span>&copy; Exotic 2015 All right reserved. <a href="http://webthemez.com/free-bootstrap-templates/" target="_blank">Free Bootstrap Templates</a> by WebThemez.</p>
                            </div>
                        </div>
